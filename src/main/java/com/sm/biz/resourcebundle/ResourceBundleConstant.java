 ...
 * @version create on 2017年11月10日 下午11:48:12
 */
public interface ResourceBundleConstant {
  ...
  // code后缀
  String XPATH_RESOURCE_CODE_SUFFIX =
      StringUtils.substring(XPATH_RESOURCE_MESSAGE_CODE, XPATH_RESOURCE_MESSAGE_SPACE.length());
}
