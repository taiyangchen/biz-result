 ...
 * <code>ResourceBundle</code>采用了和 <code>java.util.ResourceBundle</code> 相同的资源查找策略, 但使用了factory模式,
 * 使之更容易扩展出新的资源格式.
 * </p>
 * 
 * <p>
 ...
 * @version create on 2017年11月10日 下午11:45:35
 */
  ...
  protected final void setLocale(String baseName, String bundleName) {
    ...
    if (baseName.length() < bundleName.length()) {
      ...
      throw new IllegalArgumentException(MessageFormat
          .format(ResourceBundleConstant.RB_BASE_NAME_LONGER_THAN_BUNDLE_NAME, new Object[] {baseName, bundleName}));
    }
  }
